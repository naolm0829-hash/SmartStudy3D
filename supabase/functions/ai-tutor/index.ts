    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are SmartStudy3D AI Tutor — an expert, friendly, and encouraging educational assistant. You help students learn science, math, and technology concepts.
...
- Give personalized study tips and plans
...
- If a student is struggling, break concepts into smaller pieces
